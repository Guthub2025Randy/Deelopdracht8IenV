...
def sterkteMain(d1, d2, d3, dbh1, dbh2, dbh, msp, dha, dic_Shell_CSA, dic_csa_tank1, dic_csa_tank2, dic_csa_tank3, cob, h, bouyant_volume, length_schip, it, l_shell, i_x_shell, B_CSA2, lcg_TP, lengte_cm, STRAAL_TP, rest_thickness, transom_bhd_thickness, kraan_lcg, swlmax, straal_kraanhuis, WEIGHT_KRAAN_TOTAAL):
    ...
    kracht_TP = berekenKrachtVerdeling(lcg_TP, -WEIGHT_TRANSITION_PIECE*100, lengte_cm, STRAAL_TP)
    ...
    q = neerwaartse_kracht_1 + opwaartse_Kracht + neerwaartse_kracht_2 + Kracht_Ballast + neerwaartse_kracht_3 + kracht_kraan + kracht_TP # + spiegel_g De netto belasting kracht_TP + 
    #plotten van q
...
sterkteMain(d1, d2, d3, dbh1, dbh2, dbh, msp, dha, dic_Shell_CSA, dic_csa_tank1, dic_csa_tank2, dic_csa_tank3, cob, h, bouyant_volume, length_schip, it, l_shell, i_x_shell, B_CSA2, lcg_TP, lengte_cm, STRAAL_TP, rest_thickness, transom_bhd_thickness, kraan_lcg, swlmax, straal_kraanhuis, WEIGHT_KRAAN_TOTAAL)