...
L = 14000  # Totale lengte van het schip in cm
cg = 3200  # Zwaartepunt in cm
straal_lading = 400  # Standaardafwijking (straal van 4 m)
...
x = np.linspace(-900, 14100, 15001)  # cm
...
plt.axvline(cg / 100, color="r", linestyle="--", label="Zwaartepunt lading (32 m)")
plt.xlabel("Lengte langs het schip (m)")
plt.ylabel("Verdeelde belasting  [N]")
