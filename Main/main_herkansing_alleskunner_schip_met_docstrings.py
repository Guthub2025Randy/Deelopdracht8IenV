...
def main(versienummers):
    """
    functie bepaalt het GM en de weerstand bij 14 knopen van de verschillende schepen die als lijst worden doorgegeven aan de functie. De minimale huiddikte wordt ook bepaald, maar niet teruggegeven.
    Inputs:
    versienummers (list): lijst met de versienummers van de te gebruiken schepen
    Returns:
    g_m_enen (lijst): de waarden voor de GM van de verschillende schepen
    weerstanden (lijst): de waarden voor de weerstand bij 14 knopen van de verschillende schepen.
    """
    g_m_en = []
    weerstanden = []
