...
output_1(4, str(entrance_angle), Rtot_14knp, G_M, 20, msp["Loa  [m]"], msp["B [m]"], H, msp["T moulded [m]"], 
         ...
         (calculateKrachtensom1(krachten3)[0]*(tcg_schip - COB[1])), 4, -gewicht_transition_piece*GRAVITATION_CONSTANT, lcg_tp, tcg_tp, vcg_tp)
output_kraan(swlmax, -gewicht_transition_piece*GRAVITATION_CONSTANT, lengte_kraan_fundatie, Draaihoogte_kraan, jib_length, Zwenkhoek, 
